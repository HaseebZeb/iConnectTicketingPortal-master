    ...
    public class NotificationsController : Controller
    {
        ...
        public ActionResult Index(int? NotificationId)
        {
            ...
            if (model.Role == RoleTypes.SubAdmin)
                options.Add(new SelectListItem { Text = "SuperAdmin", Value = "4" });
            else if (model.Role == RoleTypes.SuperAdmin)
            {
                ...
                options.Add(new SelectListItem { Text = "SubAdmins", Value = "5" });
            }
            ...
            foreach (var notification in model.Notifications)
            {
                switch (notification.TargetAudienceType)
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        notification.TargetAudience = "SuperAdmin";
                        break;
                    case 5:
                        notification.TargetAudience = "SubAdmins";
                        break;
                }
            }
