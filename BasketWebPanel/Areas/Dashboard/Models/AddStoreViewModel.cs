...
namespace BasketWebPanel.Areas.Dashboard.Models
{
    ...
    public class StoreViewModel
    {
        public StoreViewModel()
        {
            ...
            EstimatedTimeOptions = new SelectList(new List<SelectListItem>());
        }
        ...
        public string EstimatedDeliveryTimeStart { get; set; }
        
        public string EstimatedDeliveryTimeEnd { get; set; }

        public SelectList EstimatedTimeOptions { get; set; }
        public string EstimatedTimeOptionSelected { get; set; }
    }
